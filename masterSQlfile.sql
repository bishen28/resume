...
-- start writing quries from here


SELECT mov_title AS  [movie title], mov_year AS [year], mov_dt_rel AS [date of release], dir_fname,dir_lname
,act_fname,act_lname FROM movie, actor, director
